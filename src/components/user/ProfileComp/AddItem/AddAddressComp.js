...
class AddAddressComp extends Component {
    ...
    fetchAddresses = async () => {
        ...
        if (token) {
            ...
            // Nếu bạn đang quản lý danh sách địa chỉ trong component cha, bạn có thể gọi hàm từ cha
            this.props.updateAddressList(response.data); // Giả sử có hàm này từ component cha
        }
    }
    ...
    handleSubmit = async () => {
        ...
        if (token) {
            ...
            console.log(selectedDistrict, selectedProvince, selectedWard)
