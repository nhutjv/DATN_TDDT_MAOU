...
class CartDetailComp extends Component {
    ...
    //             return item;
    //         });
    //         console.log(newCartData.checked)
    //         return { cartData: newCartData };
    ...
    saveSelectedItemsToSession = () => {
        ...
        if (selectedItems.length <= 0) {
            toast.error("Bạn vẫn chưa chọn sản phẩm!");
            return
        } else {
    ...
    render() {
        ...
        return (
            <>
                <div class="container gap-6 md:p-10 lg:p-20
                font-sans max-w-5xl max-md:max-w-xl mx-auto bg-slate-50 py-20">
