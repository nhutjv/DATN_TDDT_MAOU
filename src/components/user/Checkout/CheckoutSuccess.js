            ...
            <>
                <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
                    <div className="mx-auto max-w-2xl px-4 2xl:px-0">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mb-6 md:mb-8">đơn hàng <button href="#" className="font-medium text-gray-900 dark:text-white hover:underline">#{id}</button> của bạn sẽ được xử lý trong vòng 24 giờ trong ngày làm việc. Chúng tôi sẽ thông báo cho bạn qua email sau khi đơn hàng của bạn đã được chuyển đi.</p>
