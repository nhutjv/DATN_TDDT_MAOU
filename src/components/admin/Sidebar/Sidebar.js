    ...
    <div className="w-64 h-screen overflow-y-auto bg-gradient-to-r from-[#7ec8e0] to-[#FFFF] shadow-lg rounded-none">
      ...
      <ul className="space-y-4">
        ...
        <div className="border-t border-gray-200 mt-4 pt-4">
          ...
          <li className={`flex items-center py-2 px-4 rounded-lg hover:bg-[#8e8b89] transition duration-300 ease-in-out ${isActive('/admin/vouchers') ? 'bg-[#cec7c3] text-while shadow-lg' : 'text-while'}`}>
            <FaClone className={`mr-3 ${isActive('/admin/vouchers') ? '#464341' : '#464341'}`} />
            <Link to="/admin/vouchers" className="flex-1">Voucher</Link>
          </li>
...
<div className="border-t border-gray-200 mt-4 pt-4">
  ...
  <li className={`flex items-center py-2 px-4 rounded-lg hover:bg-[#8e8b89] transition duration-300 ease-in-out ${isActive('/admin/background') ? 'bg-[#cec7c3] text-while shadow-lg' : 'text-while'}`}>
    <FaImage className={`mr-3 ${isActive('/admin/background') ? '#464341' : '#464341'}`} />
    <Link to="/admin/background" className="flex-1">Quản lý background</Link>
  </li>
</div>
